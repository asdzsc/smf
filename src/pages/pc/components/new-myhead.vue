...
=======
	<div class="headBg">
		<div class="w1920">
			...
			<div class="menu">
				<div @click="openUrl('/mark/home')" :class="{ activity: classId === 'home' }" class="menuItem">
					首页
				</div>
				<div @click="openUrl('/mark/grjn')" :class="{ activity: classId === 'grjn' }" class="menuItem">
					个人纪念馆
				</div>
				<div @click="openUrl('/member/userInfo')" :class="{ activity: classId === 'userInfo' }" class="menuItem">
					个人中心
				</div>
				<div  @click="openUrl('/mark/gybg')" :class="{ activity: classId === 'gybg' }" class="menuItem">
					关于本馆
				</div>
				<div @click="openUrl('/mark/zpg')" :class="{ activity: classId === 'zpg' }" class="menuItem">
					族谱馆
				</div>
				<div class=" caozuo">
					<div>
		...
		methods: {
			...
			menuActivity() {
				...
				if (url.includes("#/mark/grjn")) {
					...
					this.classId = "zpg";
				} else if (url.indexOf("#/mark/home") === 0) {
					this.classId = "home";
				} else {
					this.classId = "";
				}
