...
<<<<<<< HEAD
      ...
      <!-- <div class="contList">
        <div class="contItem" v-for="item in model.list" :key="item.id">
          <div class="avatar">
            <div class="left">
              <a-avatar :size="50" :src="handleAvatar(item.avatar)" />
              <span style="padding-left:10px;">{{ item.nickname }}</span>
            </div>
            <p>{{ item.createDate }}</p>
          </div>
          <p>
...
>>>>>>> c823db4e54d491eefefbdbbe1503b25dd47f1e95
      <div class="contList">
        <div class="contItem">
          ...
          <p>
            我们惋惜，因为人世间少了您带给大家的欢笑。我们欣慰，因为有您的天堂更似天堂！”我们惋惜，因为人世间少了您带给大家的欢笑。我们欣慰，因为有您的天堂更似天堂！”我们惋惜，因为人世间少了您带给大家的欢笑。我们欣慰，因为有您的天堂更似天堂！”我们惋惜，因为人世间少了您带给大家的欢笑。我们欣慰，因为有您的天堂更似天堂！”
          </p>
        </div>
        <div class="contItem">
          <div class="avatar">
...
>>>>>>> c823db4e54d491eefefbdbbe1503b25dd47f1e95
    ...
    .contMain {
      background: url("/img/pc/main.png") no-repeat center center;
      background-size: cover;
      align-items: inherit;
      text-align: center;
      height: 997px;
...
>>>>>>> c823db4e54d491eefefbdbbe1503b25dd47f1e95
    ...
    .contList {
      ...
      .contItem {
        width: 560px;
        height: 235px;
        background-image: url("/img/pc/main2.png");
        background-size: 100% 100%;
        padding: 35px;
