		...
		<div class="cont">
			...
			<a-carousel arrows :autoplay="true">
				<div slot="prevArrow" class="custom-slick-arrow left-circle">
					<img src="/img/pc/main_l.png" alt="">
				</div>
				<div slot="nextArrow" class="custom-slick-arrow right-circle">
					<img src="/img/pc/main_r.png" alt="">
				</div>
				<div><img src="/img/pc/banner4.png" /></div>
				<div><img src="/img/pc/banner4.png" /></div>
				<div><img src="/img/pc/banner4.png" /></div>
			</a-carousel>
			<div class="makeBtn">
			...
			<div class="contList">
				<div class="contItem">
					...
					<p>我们惋惜，因为人世间少了您带给大家的欢笑。我们欣慰，因为有您的天堂更似天堂！”我们惋惜，因为人世间少了您带给大家的欢笑。我们欣慰，因为有您的天堂更似天堂！”我们惋惜，因为人世间少了您带给大家的欢笑。我们欣慰，因为有您的天堂更似天堂！”我们惋惜，因为人世间少了您带给大家的欢笑。我们欣慰，因为有您的天堂更似天堂！”</p>
				</div>
				<div class="contItem">
					<div class="avatar">
						<div class="left">
		...
		.cont {
			...
			.contList {
				...
				.contItem {
					...
					// box-shadow: 0px 4px 23px 1px rgba(12, 12, 12, 0.1);
					padding: 35px;
