    ...
    <div class="cont">
      ...
      <div class="right">
        ...
        <div class="listContent">
          <div
            v-for="(item, index) in pageHot.list"
            :key="item.id"
            @click="$router.push('/xwzx/zbggInfo?id=' + item.id)"
            class="item"
          >
            <div class="xh" :class="{ activity: index <= 2 }">
              {{ index + 1 }}
            </div>
...
import { newsZbggList, newsZbggInfo } from "@/pages/pc/api/news";
