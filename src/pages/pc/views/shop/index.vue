        ...
        <div class="goodsCont">
          <div class="goodsItem">
            ...
            <div class="goodsTitleCont">
              <div class="goodsTitle">明星产品</div>
              <div class="goodsSubhead">最畅销精简设计的纪念碑</div>
              <div class="goodsPrice">
                <!-- <span class="money">￥</span> 000.00 -->
              </div>
            </div>
            <div class="buyCont">
          ...
          <div class="goodsItem">
            ...
            <div class="goodsTitleCont">
              <div class="goodsTitle">经典立式</div>
              <div class="goodsSubhead">精品典雅纪念碑</div>
              <div class="goodsPrice">
                <!-- <span class="money">￥</span> 000.00 -->
              </div>
            </div>
          ...
          <div class="goodsItem">
            ...
            <div class="goodsTitleCont">
              <div class="goodsTitle">经典卧式</div>
              <div class="goodsSubhead">宝石精品纪念碑</div>
              <div class="goodsPrice">
                <!-- <span class="money">￥</span> 000.00 -->
              </div>
            </div>
    ...
    <div class="goods">
      ...
      <div v-if="xhAllList.length > 0" class="goodsCont">
        <div @click="openGoodsInfo(xhMainInfo)" class="goodsLeft">
          ...
          <div class="buyCont">
            <div @click.stop="openGoodsInfo(xhMainInfo)" class="buyLeft">
              加入购物车
            </div>
    ...
    <div class="etiquette">
      <div class="etiquetteCont">
        <div class="etiquetteLeft">
          <div class="etiquetteLeftTitle">礼仪服务</div>
...
<script>
import { bannerList, goodsColumnList, goodsList } from "@/pages/pc/api/shop";
