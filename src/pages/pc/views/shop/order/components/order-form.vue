		...
		<div class="contInfo">
			<div class="fromCont">
				<a-row class="fromRow" type="flex">
					...
					<a-col class="inputCont">
						<a-input v-model="model.contacts" placeholder="请填写联系人姓名" style="width:200px;" />
					</a-col>
					<a-col flex="80px" class="lable">
						手机号：
					</a-col>
					<a-col class="inputCont">
						<a-input v-model="model.mobile" placeholder="请填写手机号" style="width:200px;" />
					</a-col>
				</a-row>
				<a-row class="fromRow" type="flex">
					<a-col flex="80px" class="lable">
					...
					<a-col class="inputCont">
						<a-date-picker v-model="model.serveTimeDate" :disabled-date="disabledDate" @change="onChangeDate" placeholder="请选择服务时间"
						 style="width:200px;" inputReadOnly />
					</a-col>
					<a-col flex="80px" class="lable">
						服务方式：
					</a-col>
					<a-col class="inputCont">
						<a-select v-model="model.serveType" style="width: 200px" placeholder="请服务方式">
							<a-select-option value="代客服务">
								代客服务
							</a-select-option>
							<a-select-option value="自取方式">
								自取方式
							</a-select-option>
						</a-select>
					</a-col>
				...
				<a-row class="fromRow" type="flex">
					...
					<a-col class="inputCont">
						<a-textarea v-model="model.remark" placeholder="选填:对本次服务的说明" style="width: 500px;" :auto-size="{ minRows: 5, maxRows: 5 }" />
					</a-col>
				</a-row>
			</div>
		</div>
