<template>
  <div class="member">
    ...
    <div class="cont">
      ...
      <div class="line"></div>
      <div class="right">
        <div class="title">手续办理</div>
        <a-row type="flex" style="line-height: 36px">
          <a-col style="padding-right: 10px">墓址：</a-col>
          ...
          <a-col>
            <div @click="search()" class="btn">查询</div>
          </a-col>
        </a-row>
        <div
          style="
...
<script>
import { findSaleCemeteryFormalities } from "@/pages/pc/api/smferp";
...
export default {
  ...
  methods: {
    ...
    dataList() {
      this.loading = true;
      findSaleCemeteryFormalities(this.model).then((res) => {
        this.loading = false;
        if (res.code === 0) {
