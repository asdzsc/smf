<template>
  ...
  >
    ...
    ></mediaAddImage>
    <mediaAddVideo
      v-if="showMediaAddVideo"
      :id="infoId"
      :memoryId="memoryId"
      ref="mediaAddVideo"
      @onClose="closeMediaAddVideo"
    ></mediaAddVideo>
  </a-modal>
</template>
<script>
...
import { memoryMediaList, delMemoryMedia } from "@/pages/pc/api/mark.js";
export default {
  components: {
    showImg: () => import("@/pages/pc/views/member/components/show-img.vue"),
    // eslint-disable-next-line vue/no-unused-components
    memoryMedia: () =>
      import("@/pages/pc/views/member/components/show-media.vue"),
    mediaAddImage: () =>
      import("@/pages/pc/views/member/components/show-media-addImage.vue"),
    mediaAddVideo: () =>
