<template>
  ...
  >
    <div :class="['global-header-wide', layout]">
      ...
      >
        <img width="32" src="/img/admin/logo.png" />
...
export default {
  name: "GlobalHeader",
  components: { headerAvatar: () => import("@/pages/admin/layouts/HeaderlAvatar") },
  props: ["collapsed"],
  computed: {
    isMobile() {
    ...
    theme() {
      return this.layout === "side" ? "light" : this.$store.state.adminSetting.theme;
    },
    systemName() {
