  ...
  <div style="padding-top: 30px">
    ...
    <div class="card">
      <a-row type="flex" class="cardCont">
        ...
        <a-col :span="12">
          <a-divider orientation="left"> 服务人员反馈 </a-divider>
          ...
          <div style="padding: 10px 0px; text-align: center">
            <a-button @click="addFeedback()" type="primary">
              <a-icon type="plus" />添加反馈
            </a-button>
          </div>
        </a-col>
      </a-row>
...
export default {
  components: {
    ...
    orderComment: () =>
      import("@/pages/admin/views/shop/order/components/order-comment.vue"),
  },
  props: {
    shopOrder: {
      type: Object,
  ...
  methods: {
    ...
    getCommentList(commentType) {
      var list = this.shopOrder.commentList.filter(
        (x) => x.comment_type === commentType
      );
      return list;
    },
    getAvatar(record) {
