<template>
	<a-modal title="上传视频" v-model="visible" width="600px" :bodyStyle="{ padding: '10px',minHeight:'400px' }" @cancel="onClose"
	 @ok="handleOk">
		<a-form-model :model="model" :label-col="{ span: 4 }" :wrapper-col="{ span: 18 }">
			...
			<a-form-model-item label="视频" class="formItemAvatar">
				<div style="padding-top: 10px;">
					<fileUpload ref="fileUpload" accept="video/mp4" :count="1" :multiple="false" @uploading="uploadingFileUpload"
