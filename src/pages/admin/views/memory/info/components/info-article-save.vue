<template>
	<a-modal :title="title" v-model="visible" width="800px" :bodyStyle="{ padding: '10px' }" @cancel="onClose" @ok="handleOk">
		...
		<a-form-model :model="model" :label-col="{ span: 4 }" :wrapper-col="{ span: 18 }">
			...
			<a-form-model-item label="标题">
				<a-input v-model="model.title" placeholder="请输入标题" style="width:100%;" />
			</a-form-model-item>
			<a-form-model-item label="内容">
				<a-textarea v-model="model.cont" placeholder="请输入内容" :rows="5" style="width:100%;" />
			</a-form-model-item>
		</a-form-model>
