  ...
  >
    <div class="form">
      ...
      <a-row type="flex" class="formRow">
        <a-col class="lable"> 主页类型 </a-col>
        <a-col class="text">
          <a-select
            v-model="model.memoryType"
            style="width: 350px"
            placeholder="请选择主页类型"
          >
            <a-select-option value="0"> 普通主页 </a-select-option>
            <a-select-option value="1"> 名人主页 </a-select-option>
          </a-select>
        </a-col>
      </a-row>

      <a-row type="flex" class="formRow">
        <a-col class="lable"> 所属类别 </a-col>
        <a-col class="text">
          <a-select
            v-model="model.columnIdsKey"
            mode="multiple"
            @change="changeColumnIds"
            style="width: 350px"
            placeholder="请选择所属类别"
          >
            <a-select-option value=""> 请选择所属类别 </a-select-option>
            <a-select-option
        ...
        <a-col class="text">
          <a-select
            ...
            placeholder="请选择所属模版"
          >
            <a-select-option value="0"> 免费模版 </a-select-option>
            <a-select-option
        ...
        <a-col class="text">
          <a-dropdown :trigger="['click']">
            <div>
              <a-input
                ...
                placeholder="请输入安葬墓址"
                :style="
                  cemeteryList.length > 0 ? 'width: 330px' : 'width: 350px'
                "
              />
              &nbsp;
              <a
          ...
          >
            ...
            <a-select-option
              ...
              :label="item.cemetery"
            >
              主办人：{{ item.masterName }}<br />{{ item.cemetery }}
            </a-select-option>
          </a-select> -->
      ...
      <a-row type="flex" class="formRow">
        <a-col class="lable"> 排序 </a-col>
        <a-col class="text">
          <a-input-number :min="0" v-model="model.sortId" />
        </a-col>
        <a-col class="lable"> 到期时间 </a-col>
        <a-col class="text">
          <a-date-picker
            v-model="model.expireTimeDate"
            placeholder="请选择到期时间"
            @change="changeExpireTimeDate"
            style="width: 350px"
            inputReadOnly
          />
        </a-col>
...
import { getGoodsList } from "@/pages/admin/api/shop/goods";
...
export default {
  ...
  methods: {
    ...
    changeExpireTimeDate(date, dateString) {
      ...
      this.model.expireTime = dateString + " 00:00:00";
    },
    //是否公开
    setStatus() {
