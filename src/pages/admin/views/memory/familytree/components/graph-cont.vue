        ...
        <table>
          ...
          <tr>
            ...
            <td>
              ...
              >
                <a-button type="primary" slot="enterButton"> 选择 </a-button>
              </a-input-search>
            </td>
          </tr>
          <tr>
...
export default {
  components: {
    ...
    memoryList: () =>
      import(
        "@/pages/admin/views/memory/familytree/components/memory-list.vue"
      ),
  },
  props: {},
  data() {
    ...
    delNode() {
      ...
      if (nid) {
        this.$confirm({
          ...
          content: "",
          onOk() {
            vm.graph_json_data.nodes = vm.graph_json_data.nodes.filter(
              (x) => x.id !== nid
            );
            vm.graph_json_data.links = vm.graph_json_data.links.filter((x) => {
              return x.from !== nid || x.to !== nid;
            });
