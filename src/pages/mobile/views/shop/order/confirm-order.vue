  ...
  <div class="confirmOrder">
    <div class="orderTitle">
      <div class="link">
        ...
        <span> <van-icon name="arrow" />核对订单信息 </span>
      </div>
    </div>
    <div class="orderInfo">
      <div class="cont">
    ...
    <div class="totalWrap">
      <div class="totalMoney">
        {{ goodsNum }}件商品 合计:<span class="money">{{
          totalPriceText
        }}</span>
      </div>
...
<script>
import { saveOrder, getCartNum } from "@/pages/mobile/api/shop";
export default {
  components: {
    orderAddress: () =>
      import("@/pages/mobile/views/shop/order/components/order-address.vue"),
    orderForm: () =>
      import("@/pages/mobile/views/shop/order/components/order-form.vue"),
    orderPayType: () =>
      import("@/pages/mobile/views/shop/order/components/order-pay-type.vue"),
    orderGoodsList: () =>
      import("@/pages/mobile/views/shop/order/components/order-goods-list.vue"),
  },
  data() {
    return {
  ...
  computed: {
    //显示服务墓址
    showOrderAddress() {
      console.log("this.model.orderType", this.gid, this.model.orderType);
