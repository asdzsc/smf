<template>
  <div>
    ...
    <div class="bannerTitle">
      ...
      <div class="text2" style="padding-top: 0.3rem">
        多名人生圆满服务设计师、生命文化礼仪师<br />从“爱”到一种职业
      </div>
    </div>
    ...
    <div>
      <van-image fit="cover" src="/img/mobile/rsjnfw_intro2.png" />
    </div>
    ...
    <div class="cont">
      ...
      <div class="itemCont">
        <div class="itemImg">
          <van-image fit="cover" src="/img/mobile/rsjnfw2.png" />
        </div>
