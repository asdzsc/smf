...
<<<<<<< HEAD
        ...
        <div class="bannerInfo">
          <p class="bannerName">{{ detailModal.name }}</p>
...
>>>>>>> c823db4e54d491eefefbdbbe1503b25dd47f1e95
      <div class="title">
        <img src="/img/mobile/mark/title_05.png" alt="" />
        <p>纪念相册</p>
        <img src="/img/mobile/mark/title_05.png" alt="" />
      </div>
<<<<<<< HEAD
...
.grjn {
  background-image: url("/img/mobile/mark/banner_05.png");
  ...
  .ly {
    ...
    .lyInfo {
      ...
      .lyList {
        ...
        margin-top: 0.5rem;
        box-shadow: 0px 4px 19px 1px rgba(158, 143, 140, 0.2);
        border: solid 0.03rem #ffdcd4;
        .lyListInfo {
          margin-left: 0.2rem;
          .lyListGift {
            display: flex;
