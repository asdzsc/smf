  ...
  <div class="grjn">
    ...
    <div class="photo" v-if="showPhoto">
      <div class="title" style="margin-top: 1rem">
        <p>纪念</p>
        <img src="/img/mobile/mark/star_03.png" alt="" />
        <p>相册</p>
      </div>
    ...
    <!-- video end -->
    <img style="width: 100%" src="/img/mobile/mark/banner03.png" alt="" />
  </div>
</template>
...
.grjn {
  background-image: url("/img/mobile/mark/banner_03.png");
  ...
  .ly {
    ...
    .lyInfo {
      ...
      .lyList {
        ...
        margin-top: 0.5rem;
        background-image: url("/img/mobile/mark/ly_03.png");
        background-size: 100% 100%;
        .lyListInfo {
          margin-left: 0.2rem;
          .lyListGift {
