...
<<<<<<< HEAD
      <img style="width: 100%" src="/img/mobile/mark/01.png" alt="" />
...
.grjn {
  background-image: url("/img/mobile/mark/banner_01.png");
  ...
  .ly {
    ...
    .lyTitle {
      ...
      .lyBtn {
        ...
        line-height: 0.55rem;
        color: #eae9e9;
        background-image: url("/img/mobile/mark/ly_btn.png");
        text-align: center;
        background-size: 100% 100%;
        margin-top: 10%;
      }
    ...
    .lyInfo {
      ...
      .lyList {
        ...
        margin-top: 0.5rem;
        background-image: url("/img/mobile/mark/ly_01.png");
        background-size: 100% 100%;
        .lyListInfo {
          margin-left: 0.2rem;
          .lyListGift {
...
>>>>>>> c823db4e54d491eefefbdbbe1503b25dd47f1e95
    .articleInfo {
      .articleList {
        ...
        background-image: url("/img/mobile/mark/wz_01.png");
        background-size: 100% 100%;
        margin-top: 0.5rem;
        padding: 0.5rem;
        box-sizing: border-box;
