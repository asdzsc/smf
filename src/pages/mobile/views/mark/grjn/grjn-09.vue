...
<<<<<<< HEAD
        ...
        <div class="bannerInfo">
          ...
          <div class="bannerBtn" @click="handleClick">
            纪念Ta<img src="/img/mobile/mark/pen.png" alt="" />
          </div>
...
=======
        ...
        <div class="bannerInfo">
          ...
          <div class="bannerBtn">
            纪念他
            <img src="/img/mobile/mark/pen.png" alt="" />
          </div>
...
<<<<<<< HEAD
    ...
    <!-- video end -->
    <img style="width: 100%" src="/img/mobile/mark/09.png" alt="" />
=======
      <div class="videoInfo">
        <div class="videoList">
          <video
...
.grjn {
  background-image: url("/img/mobile/mark/banner_09.png");
...
>>>>>>> c823db4e54d491eefefbdbbe1503b25dd47f1e95
  ...
  .title {
    ...
    margin: 0.5rem auto;
    p {
      background-image: url(/img/mobile/mark/title_09.png);
  ...
  .ly {
    ...
    .lyInfo {
      ...
      .lyList {
        ...
        margin-top: 0.5rem;
        background-image: url("/img/mobile/mark/ly_09.png");
        background-size: 100% 100%;
...
>>>>>>> c823db4e54d491eefefbdbbe1503b25dd47f1e95
    .articleInfo {
      ...
      box-shadow: 0px 0.04rem 0.19rem 0.01rem rgba(158, 143, 140, 0.2);
      border: solid 3px #a35524;
      .articleList {
        width: 100%;
